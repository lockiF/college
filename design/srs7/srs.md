...
Загальна кількість пунктів меню в кабінеті — близько 15. Для нового користувача  перевантажено. «Реєстри», «Післяплати», «Фулфілмент» — для звичайного користувача виглядають однаково незрозуміло, ієрархія між ними недостатньо чітка.
